...
parser.add_argument("--host",       default="10.184.204.50", help="Bind IP for servers")
parser.add_argument("--lb-host",    default="10.184.204.118", help="Load balancer IP for servers to send to")
