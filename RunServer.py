...
parser.add_argument("--host",       default="10.30.204.147", help="Bind IP for servers")
parser.add_argument("--lb-host",    default="10.30.201.127", help="Load balancer IP for servers to send to")
